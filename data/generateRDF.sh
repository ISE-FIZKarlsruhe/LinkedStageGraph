...
#BASE=http://slod.fiz-karlsruhe.de/
#GRAPH=http://slod.fiz-karlsruhe.de/
...
sed 's/https:\/\/github.com\/ISE-FIZKarlsruhe\/LinkedStageGraph\/raw\/master\/data\/origin\/labw_2_2039-fixed.xml#/http:\/\/slod.fiz-karlsruhe.de\//g' tmp/tmp2.nt > tmp/tmp3.nt
...
sed 's/http:\/\/data.archiveshub.ac.uk\/id\//http:\/\/slod.fiz-karlsruhe.de\//g' tmp/saxon-out.rdf  > tmp/saxon-out2.rdf
